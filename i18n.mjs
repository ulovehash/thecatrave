...
export const locales = {
  en: {
    ...
    categories: {'music-history':'Music history', festivals:'Festivals', 'rave-spots':'Rave spots', digging:'Digging'},
    categoriesAll: 'All',
    cardReadingTime: time => `${time} read`,
    categoriesLabel: 'Filter articles by category',
    homeNavMixes: 'Mixes',
    ...
    homeSelectorTitle: "Can't decide what to listen to?",
  ...
  de: {
    ...
    categories: {'music-history':'Musikgeschichte', festivals:'Festivals', 'rave-spots':'Rave-Spots', digging:'Digging'},
    categoriesAll: 'Alle',
    cardReadingTime: time => `${time.replace(/min$/, 'Min.')} Lesezeit`,
    categoriesLabel: 'Artikel nach Kategorie filtern',
    homeNavMixes: 'Mixe',
    homeNavTracks: 'Tracks',
    homeNavPlaylists: 'Playlists',
    ...
    homeSelectorKicker: 'Tool',
    homeSelectorTitle: 'Du weißt nicht, was du hören sollst?',
  ...
  fr: {
    ...
    categories: {'music-history':'Histoire de la musique', festivals:'Festivals', 'rave-spots':'Spots de rave', digging:'Digging'},
    categoriesAll: 'Tous',
    cardReadingTime: time => `${time} de lecture`,
    categoriesLabel: 'Filtrer les articles par catégorie',
    homeNavMixes: 'Mixes',
    ...
    homeSelectorTitle: 'Vous ne savez pas quoi écouter ?',
