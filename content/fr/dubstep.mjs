...
export default {
  ...
  media: ({lang}) => ({
    ...
    'thecatrave berlin-race-1909': ownTrackListening('berlin-race-1909', 'L’espace de la techno et des rythmiques brisées : la même rencontre berlinoise, écoutée aujourd’hui. Mon propre morceau.', lang),
