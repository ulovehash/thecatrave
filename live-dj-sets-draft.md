...
So what is a Boiler Room party? A filmed event with a guest list. You RSVP and hope, because the rooms are small, and everyone else watches the stream. When Charli xcx played in Bushwick, Brooklyn in February 2024, more than 25,000 people RSVPed, the most in Boiler Room's history. For the sets themselves, ranked and counted, see [the best Boiler Room sets](/best-boiler-room-sets).
...
Every number here comes from the [Selector](/selector), which is also the quickest way to use all of this: press the button and it picks one of these sets for you.
