...
The place to find them is YouTube, where Boiler Room, HÖR, Cercle, Dekmantel, Keep Hush and every radio station above upload the recordings. This guide to [where to watch live DJ sets](/live-dj-sets) explains how the main archives differ, while [the best Boiler Room sets](/best-boiler-room-sets) gives you a shorter starting list. The problem is the same one you started with: there are tens of thousands of them, the names mean nothing to you, and you cannot tell from a name whether an hour is worth your evening.
...
## Follow the producer, not the artist
...
## Labels that stick to one sound
