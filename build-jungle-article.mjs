...
const structured = articleStructuredData({headline:h1,description,datePublished:'2025-04-05',dateModified:'2026-08-31',canonical:'https://thecatrave.com/jungle-music-guide',image:'https://thecatrave.com/img/UK%20Rave%20flyers%20from%201991-1994.webp'});
...
fs.writeFileSync(path, articlePage({
  ...
  alternates: alternatesFor('/jungle-music-guide'),
