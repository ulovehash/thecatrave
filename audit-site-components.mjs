...
const checks = {
  ...
  homeArticleReadingTimesCurrent: currentHomeArticles.every(item => pages.home.includes(`<span class="label">${t('en').cardReadingTime(item.readingTime)}</span>`)),
