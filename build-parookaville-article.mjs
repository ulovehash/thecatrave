...
//
// Keywords (global volume, September 2026): parookaville festival 900 (600 of
// it DE, TP 2,700), parookaville weeze 250, parookaville mainstage 200, bill
// parooka 150, parookaville location 30, where is parookaville 10. The demand
// is German: 31,000 DE of 37,000 for the head term. The page is in English and
// answers the German questions without the German phrases. Lineups, dated
// editions, set times, livestream schedules and tickets are excluded on
// purpose; one dated price answer sits in the FAQ. See keywords/parookaville.json.
//
...
const draft = fs.readFileSync('parookaville-draft.md', 'utf8').replace(/—/g, ':');
...
const media = {
  ...
  'ParookavilleMainLuftbild22': figure('mainstage-aerial-2022', 1200, 900,
    ...
    'The Parookaville Mainstage from the air in July 2022, the first edition after the pandemic. It holds 45,000 people and is rebuilt to a new design every year. Photograph: Timo, CC BY-SA 4.0.'),
...
${sourceLink('https://www.parookaville.com/de/agb', 'Parookaville: ticket terms (AGB)')}
...
${sourceLink('https://nordevents.net/news/parookaville-2025/', 'Nordevents: Parookaville 2025')}
...
${sourceLink('https://edmhousenetwork.com/parookaville-2026-full-lineup-announced/', 'EDM House Network: Parookaville 2026 full lineup announced')}
