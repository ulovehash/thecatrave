...
const tracks = [
  ...
  {year:'1988', artist:'Mantronix', title:'King of the Beats', note:'The record that made the Amen break the subject of a track rather than the bed underneath one, a decade before British rave producers pitched it up.', embed:{type:'spotify', id:'5odEZsaNzWnNihJjibL49h'}},
...
const nuSkoolBreaksPlaylist = articleListeningBand({
  ...
  iframeTitle:'The Sound of Nu Skool Breaks playlist on Spotify', tone:'cyan'
});
...
${section('Where Did Breakbeat Come From?','origins',{
  beforeHeading:{
    'Hip-hop DJs turn the break into a method':trackGroup([1,2,3,4],'The breaks before the genre','Hear the source records as performances first: each break carries a different human feel before later producers cut it apart.')
  },
  afterParagraph:{
...
${section('How Breakbeat Became Club Music','club-history',{
  ...
  beforeHeading:{
    'Pirate radio, record shops and dubplates':trackGroup([5,6,7,8,9],'British rave starts to fracture','These records show breakbeat hardcore moving from fast UK hip-hop into chart rave, darker pressure and ragga crossover.'),
    'Acid, progressive and West Coast breaks widen the American map':trackGroup([13],'Florida becomes its own scene','DJ Icey’s production makes the local mixture of electro, Miami bass and rolling breaks audible.'),
    'Andalusia turns breakbeat into mass regional culture':trackGroup([11,12],'Acid and West Coast routes','One track enlarges acid breakbeat; the other turns towards electro and the American West Coast.'),
    'Nu-skool breaks builds a dedicated circuit':trackGroup([10],'Breaks reach crossover scale','Chemical Beats shows how acid repetition and hip-hop-sized drums could move from clubs towards festival-scale production.'),
    'Why the dedicated breaks circuit became less visible':trackGroup([14,15,16],'Nu-skool becomes a dedicated circuit','Progressive scale, sharpened edits and UK garage swing show how wide the early-2000s breaks ecosystem became.')
  },
  afterParagraph:{
...
const preservedPage = page
  ...
  .replace(
    '<aside class="context-listening context-listening-full listening-cyan" aria-labelledby="listen-the-breaks-before-the-genre">',
    '<a id="tracks"></a><aside class="context-listening context-listening-full listening-cyan" aria-labelledby="listen-the-breaks-before-the-genre">'
  )
  .replace(
