...
if (fs.existsSync(`${root}/report.json`)) {
  ...
  console.log(`last result: ${report.resolvedSets} total refined (${report.newlyResolved ?? report.resolvedSets} new in last run) from ${report.acceptedArtists} artists`);
}
