...
export const pages = [
  ...
  { name: 'best-spotify-playlists', file: 'best-spotify-playlists.html', path: '/best-spotify-playlists', kind: 'guide', generator: 'build-best-spotify-playlists-article.mjs', card: { title: 'Best Spotify playlists', caption: "Twelve human-curated lists, including the electronic underground." } },
  ...
  { name: 'de-beste-spotify-playlists', lang: 'de', translationOf: '/best-spotify-playlists', file: 'de/beste-spotify-playlists.html', path: '/de/beste-spotify-playlists', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Beste Spotify-Playlists', caption: "Zwölf von Menschen kuratierte Listen, darunter der elektronische Underground." } },
  ...
  // French, from 2026-09-18: the same language layer as German (i18n.mjs).
  { name: 'fr-tomorrowland', lang: 'fr', translationOf: '/tomorrowland-festival', file: 'fr/festival-tomorrowland.html', path: '/fr/festival-tomorrowland', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Tomorrowland', caption: "Un parc belge que le monde connaît par le livestream." } },
  { name: 'fr-coachella',    lang: 'fr', translationOf: '/what-is-coachella', file: 'fr/festival-coachella.html', path: '/fr/festival-coachella', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Coachella', caption: "Deux week-ends d’avril dans le désert californien." } },
  { name: 'fr-burning-man',  lang: 'fr', translationOf: '/what-is-burning-man', file: 'fr/burning-man.html', path: '/fr/burning-man', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Burning Man', caption: "Une ville éphémère dans le désert du Nevada." } },
  { name: 'fr-glastonbury',  lang: 'fr', translationOf: '/glastonbury-festival', file: 'fr/festival-glastonbury.html', path: '/fr/festival-glastonbury', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Glastonbury', caption: "Cinq jours de juin dans une ferme du Somerset." } },
  { name: 'fr-berlin-clubs', lang: 'fr', translationOf: '/best-clubs-in-berlin', file: 'fr/boite-de-nuit-berlin.html', path: '/fr/boite-de-nuit-berlin', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Clubs de Berlin', caption: "De l’UFO et du Tresor au Berghain et au Sisyphos." } },
  { name: 'fr-primavera-sound', lang: 'fr', translationOf: '/primavera-sound-barcelona', file: 'fr/primavera-sound-barcelona.html', path: '/fr/primavera-sound-barcelona', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Primavera Sound', caption: "Le festival de Barcelone au bord de la mer : lieu, dates, taille, musique." } },
  { name: 'fr-drum-and-bass', lang: 'fr', translationOf: '/drum-and-bass-guide', file: 'fr/drum-and-bass.html', path: '/fr/drum-and-bass', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Drum and bass', caption: "174 BPM, breakbeats et sub-bass venus de Grande-Bretagne." } },
  { name: 'fr-dubstep',      lang: 'fr', translationOf: '/dubstep-guide', file: 'fr/dubstep.html', path: '/fr/dubstep', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Dubstep', caption: "Un mot, deux genres : de Croydon à la scène de festival." } },
  { name: 'fr-mysteryland',  lang: 'fr', translationOf: '/mysteryland-festival', file: 'fr/festival-mysteryland.html', path: '/fr/festival-mysteryland', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Mysteryland', caption: "Une rave de 1993 installée à Haarlemmermeer." } },
  ...
  { name: 'fr-meilleures-playlists-spotify', lang: 'fr', translationOf: '/best-spotify-playlists', file: 'fr/meilleures-playlists-spotify.html', path: '/fr/meilleures-playlists-spotify', kind: 'guide', generator: 'build-localized-articles.mjs', card: { title: 'Meilleures playlists Spotify', caption: "Douze sélections humaines, dont l’underground électronique." } },
