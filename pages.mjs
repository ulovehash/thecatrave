...
export const pages = [
  ...
  { name: 'london-clubs',   file: 'clubs-in-london.html',          path: '/clubs-in-london',              kind: 'guide', generator: 'build-london-clubs-article.mjs', card: { title: 'London clubs', caption: "Heaven to FOLD: the rooms that made the music, and the best now." } },
