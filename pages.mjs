...
export const pages = [
  ...
  { name: 'articles',      file: 'articles.html',                      path: '/articles',                     kind: 'index', generator: 'build-articles-page.mjs', card: { title: 'Articles', caption: "Every guide on the site, newest first." } },
